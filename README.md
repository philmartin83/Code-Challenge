...
I use a cocoa pod called TinyContraints to handle my view layout because in my opinion is a lot cleaner and more readable the using NSLayoutConstraints and there is no need to set translatesAutoresizingMaskIntoConstraints because TinyConstraints does it for you.
...
![Screenshot](https://github.com/philmartin83/DemoProject/blob/master/Images/screenshot.png)
